                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, point), { image_url: "http://10.0.2.15:3333/uploads/" + point.image });
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        serializedPoint = __assign(__assign({}, point), { image_url: "http://192.168.0.102:3333/uploads/" + point.image });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        pointItems = items.split(',').map(function (item) { return Number(item.trim()); })
